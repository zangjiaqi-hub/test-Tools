...
(function ($) {
    ...
    BootstrapTable.prototype.resetView = function (params) {
        ...
        if (this.options.showHeader && this.options.height) {
            this.$tableHeader.show();
            // this.resetHeader(); //取消表头初始化解决表头和内容不对齐问题
     ...
     *               updates a specified cell based on a unique ID
     *               the compatible table data is filtered, and the table data is displayed in different situations
     */
    BootstrapTable.prototype.updateCurDataCellById = function (params) {
        var that = this;
        if (!params.hasOwnProperty('id') ||
            !params.hasOwnProperty('field') ||
            !params.hasOwnProperty('value')) {
        ...
        $.each(allParams, function(i, params) {
            ...
            rowId = $.inArray(that.getRowByUniqueId(params.id), that.data);
    ...
    var allowedMethods = [
        ...
        'updateFormatText', 'updateCellById', 'updateCurDataCellById'
    ];
